          ...
          second_row.map((data) =>{
            return(
              <div class="repeat-item flex items-center">
                    <div class="custom-col-3" style={{"margin":"0px"}}>
                    ...
                    <div class="custom-col-3" style={{"margin":"1px"}}>
                    ...
                    <div class="custom-col-3" style={{"margin":"1px", "margin-right": "2px"}}>
                      <select
              ...
              <div  style={{display: "flex","padding-top": "0px", border: '1px solid #fff'}}>
                ...
                <div style={{flex:1}}>
                  ...
                  <div class="fixed-item flex items-center">
                    ...
                    <div class="col-4" style={{"margin":"0px", "margin-right": "3px"}}>
                      <input
                        class="col-12 repeat-el "
                        type="text"
    ...
    return (
      <div id="page" style={{"max-width": "900px;"}}>
        ...
        <div style={{display:"flex",flexDirection: 'row'}}>
          ...
          <div class="drop-down-width" style={{"padding-left":"0px"}}>
